    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
            	  ...
            	  <?php
                    ...
                    if ($page == "" || $page == 1) {
                        ...
                        $page_1 = ($page * $animal_per_page) - $animal_per_page;
                                        ...
                                        $select_amphibian = mysqli_query($connection,$query);
                                        $count = mysqli_num_rows($select_amphibian);
                                        $count = ceil($count / $animal_per_page) ;

                                         $query = "SELECT * FROM amphibians LIMIT $page_1,$animal_per_page";
                                         $select_all_amphibian_query = mysqli_query($connection,$query);




                                        while ($row = mysqli_fetch_assoc($select_all_amphibian_query)) {
                                            ...
                                            if ($select_all_amphibian_query == TRUE) {
                                            	
                                           ?>  
                                           
             <h4>Name : <?php echo $amphibian_name; ?></h4>
             ...
             <h4>Added By : <?php echo $amphibian_author; ?></h4>
             <img class="img-responsive" src="admin/images/<?php echo $amphibian_image; ?>" alt="">
