...
<?php include "includes/header.php"; ?>
    ...
    <div class="container" style="width: 50%;">
        ...
        <div id="Tickets Booked" class="tabcontent">
          ...
          $query = "SELECT * FROM bookings WHERE user_id = $curr_user_id";
            ...
            <table class="table table-striped" style="width: 50%">
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href=" receipt.php?booking_id=<?php echo $booking_id ?>">Receipt</a></td>
                </tr>
                 <td><b>Cancel Ticket<b></td>
                  <td>
                    <form action="includes/cancel.php?booking_id=<?php echo $booking_id ?>&user_id=<?php echo $user_id ?>" method="post">
...
<br><br><br>
          ...
          <h3 style="margin-bottom: -40px"><b>Past Bookings:</b></h3>
