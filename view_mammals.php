    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
            	  ...
            	  <?php
                    ...
                    if ($page == "" || $page == 1) {
                        ...
                        $page_1 = ($page * $animal_per_page) - $animal_per_page;
                                        ...
                                        $select_mammals = mysqli_query($connection,$query);
                                        $count = mysqli_num_rows($select_mammals);
                                        $count = ceil($count / $animal_per_page) ;

                                         $query = "SELECT * FROM mammals LIMIT $page_1,$animal_per_page";
                                         $select_all_mammals_query = mysqli_query($connection,$query);




                                        while ($row = mysqli_fetch_assoc($select_all_mammals_query)) {
                                            ...
                                            if ($select_all_mammals_query == TRUE) {
                                            	
                                           ?>  
                                           
             <h4>Name : <?php echo $mammals_name; ?></h4>
             ...
             <h4>Added By : <?php echo $mammals_author; ?></h4>
             <img class="img-responsive" src="admin/images/<?php echo $mammals_image; ?>" alt="">
